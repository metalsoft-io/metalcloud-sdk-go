...
func (r InfrastructureAPICancelDeployInfrastructureRequest) Execute() (*Infrastructure, *http.Response, error) {
	return r.ApiService.CancelDeployInfrastructureExecute(r)
}

/*
CancelDeployInfrastructure Cancels the specified infrastructure deployment
...
func (a *InfrastructureAPIService) CancelDeployInfrastructureExecute(r InfrastructureAPICancelDeployInfrastructureRequest) (*Infrastructure, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InfrastructureAPIService.CancelDeployInfrastructure")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/infrastructures/{infrastructureId}/actions/cancel-deploy"
	localVarPath = strings.Replace(localVarPath, "{"+"infrastructureId"+"}", url.PathEscape(parameterValueToString(r.infrastructureId, "infrastructureId")), -1)
...
type InfrastructureAPIGetAllInfrastructureStatisticsRequest struct {
	ctx context.Context
	ApiService *InfrastructureAPIService
}

func (r InfrastructureAPIGetAllInfrastructureStatisticsRequest) Execute() (*InfrastructuresStatistics, *http.Response, error) {
	return r.ApiService.GetAllInfrastructureStatisticsExecute(r)
}

/*
GetAllInfrastructureStatistics Retrieves statistics for all infrastructures

Retrieves statistics for all infrastructures

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return InfrastructureAPIGetAllInfrastructureStatisticsRequest
*/
func (a *InfrastructureAPIService) GetAllInfrastructureStatistics(ctx context.Context) InfrastructureAPIGetAllInfrastructureStatisticsRequest {
	return InfrastructureAPIGetAllInfrastructureStatisticsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return InfrastructuresStatistics
func (a *InfrastructureAPIService) GetAllInfrastructureStatisticsExecute(r InfrastructureAPIGetAllInfrastructureStatisticsRequest) (*InfrastructuresStatistics, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *InfrastructuresStatistics
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InfrastructureAPIService.GetAllInfrastructureStatistics")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/infrastructures/statistics"
...
func (r InfrastructureAPIGetInfrastructureResourceUtilizationDetailedRequest) GetResourceUtilizationDetailed(getResourceUtilizationDetailed GetResourceUtilizationDetailed) InfrastructureAPIGetInfrastructureResourceUtilizationDetailedRequest {
	r.getResourceUtilizationDetailed = &getResourceUtilizationDetailed
	return r
}
...
func (a *InfrastructureAPIService) GetInfrastructureResourceUtilizationDetailedExecute(r InfrastructureAPIGetInfrastructureResourceUtilizationDetailedRequest) (*InfrastructureResourceUtilizationResponse, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.getResourceUtilizationDetailed == nil {
		return localVarReturnValue, nil, reportError("getResourceUtilizationDetailed is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.getResourceUtilizationDetailed
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
// Filter by userIdOwner query param.  **Format:** filter.userIdOwner&#x3D;{$not}:OPERATION:VALUE    **Example:** filter.userIdOwner&#x3D;$eq:John Doe&amp;filter.userIdOwner&#x3D;$in:John Doe  **Available Operations** - $eq  - $in  - $and  - $or
...
// Filter by deployId query param.  **Format:** filter.deployId&#x3D;{$not}:OPERATION:VALUE    **Example:** filter.deployId&#x3D;$eq:John Doe  **Available Operations** - $eq  - $and  - $or
...
// Parameter to sort by. To sort by multiple fields, just provide query param multiple types. The order in url defines an order of sorting  **Format:** {fieldName}:{DIRECTION}   **Example:** sortBy&#x3D;id:DESC&amp;sortBy&#x3D;siteId:DESC   **Default Value:** id:DESC  **Available Fields** - id  - siteId  - subdomain  - subdomainPermanent  - serviceStatus 
...
// List of fields to search by term to filter result values  **Example:** id,label,siteId,subdomain,subdomainPermanent   **Default Value:** By default all fields mentioned below will be used to search by term  **Available Fields** - id  - label  - siteId  - subdomain  - subdomainPermanent  - serviceStatus 
