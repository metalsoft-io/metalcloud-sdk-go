...
type AuthenticationAPIGetBrandingRequest struct {
	ctx context.Context
	ApiService *AuthenticationAPIService
}

func (r AuthenticationAPIGetBrandingRequest) Execute() (*Branding, *http.Response, error) {
...
Returns the branding configuration (logos, favicon, company name, UI template).

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return AuthenticationAPIGetBrandingRequest
*/
func (a *AuthenticationAPIService) GetBranding(ctx context.Context) AuthenticationAPIGetBrandingRequest {
	return AuthenticationAPIGetBrandingRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return Branding
func (a *AuthenticationAPIService) GetBrandingExecute(r AuthenticationAPIGetBrandingRequest) (*Branding, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *Branding
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuthenticationAPIService.GetBranding")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/branding"
...
type AuthenticationAPILoginSamlRequest struct {
	ctx context.Context
	ApiService *AuthenticationAPIService
...
// The SAML response
func (r AuthenticationAPILoginSamlRequest) AuthenticationRequestPropertiesSaml(authenticationRequestPropertiesSaml AuthenticationRequestPropertiesSaml) AuthenticationAPILoginSamlRequest {
	r.authenticationRequestPropertiesSaml = &authenticationRequestPropertiesSaml
	return r
}

func (r AuthenticationAPILoginSamlRequest) Execute() (*http.Response, error) {
	return r.ApiService.LoginSamlExecute(r)
}

/*
LoginSaml User SAML login callback URL

SAML URL callback used by the identity provider to authenticate the user and establish a session.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return AuthenticationAPILoginSamlRequest
*/
func (a *AuthenticationAPIService) LoginSaml(ctx context.Context) AuthenticationAPILoginSamlRequest {
	return AuthenticationAPILoginSamlRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
func (a *AuthenticationAPIService) LoginSamlExecute(r AuthenticationAPILoginSamlRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AuthenticationAPIService.LoginSaml")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/login-saml"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.authenticationRequestPropertiesSaml == nil {
		return nil, reportError("authenticationRequestPropertiesSaml is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.authenticationRequestPropertiesSaml
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return nil, err
	}
...
func (r AuthenticationAPILogoutRequest) Execute() (*LogoutRequest, *http.Response, error) {
...
func (a *AuthenticationAPIService) LogoutExecute(r AuthenticationAPILogoutRequest) (*LogoutRequest, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
