...
// checks if the CreateFirmwareBinaryDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateFirmwareBinaryDto{}

// CreateFirmwareBinaryDto struct for CreateFirmwareBinaryDto
type CreateFirmwareBinaryDto struct {
...
type _CreateFirmwareBinaryDto CreateFirmwareBinaryDto
...
func (o CreateFirmwareBinaryDto) MarshalJSON() ([]byte, error) {
...
func (o CreateFirmwareBinaryDto) ToMap() (map[string]interface{}, error) {
...
func (o *CreateFirmwareBinaryDto) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateFirmwareBinaryDto := _CreateFirmwareBinaryDto{}

	err = json.Unmarshal(data, &varCreateFirmwareBinaryDto)

	if err != nil {
		return err
	}

	*o = CreateFirmwareBinaryDto(varCreateFirmwareBinaryDto)
...
type NullableCreateFirmwareBinaryDto struct {
	value *CreateFirmwareBinaryDto
	isSet bool
}

func (v NullableCreateFirmwareBinaryDto) Get() *CreateFirmwareBinaryDto {
	return v.value
}

func (v *NullableCreateFirmwareBinaryDto) Set(val *CreateFirmwareBinaryDto) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateFirmwareBinaryDto) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateFirmwareBinaryDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateFirmwareBinaryDto(val *CreateFirmwareBinaryDto) *NullableCreateFirmwareBinaryDto {
	return &NullableCreateFirmwareBinaryDto{value: val, isSet: true}
}

func (v NullableCreateFirmwareBinaryDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateFirmwareBinaryDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
