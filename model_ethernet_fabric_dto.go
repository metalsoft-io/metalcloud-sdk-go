...
// checks if the EthernetFabricDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EthernetFabricDto{}

// EthernetFabricDto struct for EthernetFabricDto
type EthernetFabricDto struct {
...
type _EthernetFabricDto EthernetFabricDto
...
func (o EthernetFabricDto) MarshalJSON() ([]byte, error) {
...
func (o EthernetFabricDto) ToMap() (map[string]interface{}, error) {
...
func (o *EthernetFabricDto) UnmarshalJSON(data []byte) (err error) {
	...
	varEthernetFabricDto := _EthernetFabricDto{}

	err = json.Unmarshal(data, &varEthernetFabricDto)

	if err != nil {
		return err
	}

	*o = EthernetFabricDto(varEthernetFabricDto)
...
type NullableEthernetFabricDto struct {
	value *EthernetFabricDto
	isSet bool
}

func (v NullableEthernetFabricDto) Get() *EthernetFabricDto {
	return v.value
}

func (v *NullableEthernetFabricDto) Set(val *EthernetFabricDto) {
	v.value = val
	v.isSet = true
}

func (v NullableEthernetFabricDto) IsSet() bool {
	return v.isSet
}

func (v *NullableEthernetFabricDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEthernetFabricDto(val *EthernetFabricDto) *NullableEthernetFabricDto {
	return &NullableEthernetFabricDto{value: val, isSet: true}
}

func (v NullableEthernetFabricDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEthernetFabricDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
