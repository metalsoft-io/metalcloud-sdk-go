...
// checks if the PaginatedVniAllocationStrategy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedVniAllocationStrategy{}

// PaginatedVniAllocationStrategy struct for PaginatedVniAllocationStrategy
type PaginatedVniAllocationStrategy struct {
	Data []VniAllocationStrategy1DataItem `json:"data"`
...
type _PaginatedVniAllocationStrategy PaginatedVniAllocationStrategy
...
func (o *PaginatedVniAllocationStrategy) GetData() []VniAllocationStrategy1DataItem {
	if o == nil {
		var ret []VniAllocationStrategy1DataItem
		return ret
	}
...
func (o PaginatedVniAllocationStrategy) MarshalJSON() ([]byte, error) {
...
func (o PaginatedVniAllocationStrategy) ToMap() (map[string]interface{}, error) {
...
func (o *PaginatedVniAllocationStrategy) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedVniAllocationStrategy := _PaginatedVniAllocationStrategy{}

	err = json.Unmarshal(data, &varPaginatedVniAllocationStrategy)

	if err != nil {
		return err
	}

	*o = PaginatedVniAllocationStrategy(varPaginatedVniAllocationStrategy)
...
type NullablePaginatedVniAllocationStrategy struct {
	value *PaginatedVniAllocationStrategy
	isSet bool
}

func (v NullablePaginatedVniAllocationStrategy) Get() *PaginatedVniAllocationStrategy {
	return v.value
}

func (v *NullablePaginatedVniAllocationStrategy) Set(val *PaginatedVniAllocationStrategy) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedVniAllocationStrategy) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedVniAllocationStrategy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedVniAllocationStrategy(val *PaginatedVniAllocationStrategy) *NullablePaginatedVniAllocationStrategy {
	return &NullablePaginatedVniAllocationStrategy{value: val, isSet: true}
}

func (v NullablePaginatedVniAllocationStrategy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedVniAllocationStrategy) UnmarshalJSON(src []byte) error {
	v.isSet = true
