...
// checks if the CreateVxlanLogicalNetworkProfile type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateVxlanLogicalNetworkProfile{}

// CreateVxlanLogicalNetworkProfile struct for CreateVxlanLogicalNetworkProfile
type CreateVxlanLogicalNetworkProfile struct {
	Label *string `json:"label,omitempty"`
	Name *string `json:"name,omitempty"`
	Annotations *map[string]string `json:"annotations,omitempty"`
	Kind LogicalNetworkKind `json:"kind"`
	FabricId int32 `json:"fabricId"`
	Vlan CreateVxlanLogicalNetworkVlanProperties `json:"vlan"`
	Vxlan CreateVxlanLogicalNetworkVxlanProperties `json:"vxlan"`
	Ipv4 CreateVxlanLogicalNetworkIpv4Properties `json:"ipv4"`
	Ipv6 *CreateVxlanLogicalNetworkIpv6Properties `json:"ipv6,omitempty"`
...
type _CreateVxlanLogicalNetworkProfile CreateVxlanLogicalNetworkProfile
...
func NewCreateVxlanLogicalNetworkProfile(kind LogicalNetworkKind, fabricId int32, vlan CreateVxlanLogicalNetworkVlanProperties, vxlan CreateVxlanLogicalNetworkVxlanProperties, ipv4 CreateVxlanLogicalNetworkIpv4Properties) *CreateVxlanLogicalNetworkProfile {
	this := CreateVxlanLogicalNetworkProfile{}
	this.Kind = kind
...
func (o *CreateVxlanLogicalNetworkProfile) GetVlan() CreateVxlanLogicalNetworkVlanProperties {
	if o == nil {
		var ret CreateVxlanLogicalNetworkVlanProperties
		return ret
	}
...
func (o *CreateVxlanLogicalNetworkProfile) GetVxlan() CreateVxlanLogicalNetworkVxlanProperties {
	if o == nil {
		var ret CreateVxlanLogicalNetworkVxlanProperties
		return ret
	}
...
func (o *CreateVxlanLogicalNetworkProfile) GetIpv4() CreateVxlanLogicalNetworkIpv4Properties {
	if o == nil {
		var ret CreateVxlanLogicalNetworkIpv4Properties
		return ret
	}
...
func (o *CreateVxlanLogicalNetworkProfile) GetIpv6() CreateVxlanLogicalNetworkIpv6Properties {
	if o == nil || IsNil(o.Ipv6) {
		var ret CreateVxlanLogicalNetworkIpv6Properties
		return ret
	}
	return *o.Ipv6
}
...
// SetIpv6 gets a reference to the given CreateVxlanLogicalNetworkIpv6Properties and assigns it to the Ipv6 field.
...
func (o *CreateVxlanLogicalNetworkProfile) SetRouteDomainIdNil() {
...
func (o *CreateVxlanLogicalNetworkProfile) SetMtuNil() {
	o.Mtu.Set(nil)
}
...
func (o CreateVxlanLogicalNetworkProfile) MarshalJSON() ([]byte, error) {
...
func (o CreateVxlanLogicalNetworkProfile) ToMap() (map[string]interface{}, error) {
...
func (o *CreateVxlanLogicalNetworkProfile) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateVxlanLogicalNetworkProfile := _CreateVxlanLogicalNetworkProfile{}

	err = json.Unmarshal(data, &varCreateVxlanLogicalNetworkProfile)

	if err != nil {
		return err
	}

	*o = CreateVxlanLogicalNetworkProfile(varCreateVxlanLogicalNetworkProfile)
...
type NullableCreateVxlanLogicalNetworkProfile struct {
	value *CreateVxlanLogicalNetworkProfile
	isSet bool
}

func (v NullableCreateVxlanLogicalNetworkProfile) Get() *CreateVxlanLogicalNetworkProfile {
	return v.value
}

func (v *NullableCreateVxlanLogicalNetworkProfile) Set(val *CreateVxlanLogicalNetworkProfile) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateVxlanLogicalNetworkProfile) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateVxlanLogicalNetworkProfile) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateVxlanLogicalNetworkProfile(val *CreateVxlanLogicalNetworkProfile) *NullableCreateVxlanLogicalNetworkProfile {
	return &NullableCreateVxlanLogicalNetworkProfile{value: val, isSet: true}
}

func (v NullableCreateVxlanLogicalNetworkProfile) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateVxlanLogicalNetworkProfile) UnmarshalJSON(src []byte) error {
	v.isSet = true
