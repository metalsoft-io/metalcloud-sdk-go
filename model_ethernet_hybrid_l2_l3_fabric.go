...
// checks if the EthernetHybridL2L3Fabric type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EthernetHybridL2L3Fabric{}

// EthernetHybridL2L3Fabric struct for EthernetHybridL2L3Fabric
type EthernetHybridL2L3Fabric struct {
...
type _EthernetHybridL2L3Fabric EthernetHybridL2L3Fabric
...
func (o EthernetHybridL2L3Fabric) MarshalJSON() ([]byte, error) {
...
func (o EthernetHybridL2L3Fabric) ToMap() (map[string]interface{}, error) {
...
func (o *EthernetHybridL2L3Fabric) UnmarshalJSON(data []byte) (err error) {
	...
	varEthernetHybridL2L3Fabric := _EthernetHybridL2L3Fabric{}

	err = json.Unmarshal(data, &varEthernetHybridL2L3Fabric)

	if err != nil {
		return err
	}

	*o = EthernetHybridL2L3Fabric(varEthernetHybridL2L3Fabric)
...
type NullableEthernetHybridL2L3Fabric struct {
	value *EthernetHybridL2L3Fabric
	isSet bool
}

func (v NullableEthernetHybridL2L3Fabric) Get() *EthernetHybridL2L3Fabric {
	return v.value
}

func (v *NullableEthernetHybridL2L3Fabric) Set(val *EthernetHybridL2L3Fabric) {
	v.value = val
	v.isSet = true
}

func (v NullableEthernetHybridL2L3Fabric) IsSet() bool {
	return v.isSet
}

func (v *NullableEthernetHybridL2L3Fabric) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEthernetHybridL2L3Fabric(val *EthernetHybridL2L3Fabric) *NullableEthernetHybridL2L3Fabric {
	return &NullableEthernetHybridL2L3Fabric{value: val, isSet: true}
}

func (v NullableEthernetHybridL2L3Fabric) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEthernetHybridL2L3Fabric) UnmarshalJSON(src []byte) error {
	v.isSet = true
