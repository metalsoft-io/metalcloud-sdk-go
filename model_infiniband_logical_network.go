...
// checks if the InfinibandLogicalNetwork type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InfinibandLogicalNetwork{}

// InfinibandLogicalNetwork struct for InfinibandLogicalNetwork
type InfinibandLogicalNetwork struct {
	Id int32 `json:"id"`
	...
	Config InfinibandLogicalNetworkConfig `json:"config"`
	Pkey InfinibandLogicalNetworkPkeyProperties `json:"pkey"`
	Ipv4 InfinibandLogicalNetworkIpv4Properties `json:"ipv4"`
	Ipv6 InfinibandLogicalNetworkIpv6Properties `json:"ipv6"`
...
type _InfinibandLogicalNetwork InfinibandLogicalNetwork
...
func (o *InfinibandLogicalNetwork) SetExtensionInstanceIdNil() {
...
func (o *InfinibandLogicalNetwork) GetConfig() InfinibandLogicalNetworkConfig {
	if o == nil {
		var ret InfinibandLogicalNetworkConfig
		return ret
	}
...
func (o *InfinibandLogicalNetwork) GetPkey() InfinibandLogicalNetworkPkeyProperties {
	if o == nil {
		var ret InfinibandLogicalNetworkPkeyProperties
		return ret
	}
...
func (o *InfinibandLogicalNetwork) GetIpv4() InfinibandLogicalNetworkIpv4Properties {
	if o == nil {
		var ret InfinibandLogicalNetworkIpv4Properties
		return ret
	}
...
func (o *InfinibandLogicalNetwork) GetIpv6() InfinibandLogicalNetworkIpv6Properties {
	if o == nil {
		var ret InfinibandLogicalNetworkIpv6Properties
		return ret
	}
...
func (o *InfinibandLogicalNetwork) SetMtuNil() {
	o.Mtu.Set(nil)
}
...
func (o InfinibandLogicalNetwork) MarshalJSON() ([]byte, error) {
...
func (o InfinibandLogicalNetwork) ToMap() (map[string]interface{}, error) {
...
func (o *InfinibandLogicalNetwork) UnmarshalJSON(data []byte) (err error) {
	...
	varInfinibandLogicalNetwork := _InfinibandLogicalNetwork{}

	err = json.Unmarshal(data, &varInfinibandLogicalNetwork)

	if err != nil {
		return err
	}

	*o = InfinibandLogicalNetwork(varInfinibandLogicalNetwork)
...
type NullableInfinibandLogicalNetwork struct {
	value *InfinibandLogicalNetwork
	isSet bool
}

func (v NullableInfinibandLogicalNetwork) Get() *InfinibandLogicalNetwork {
	return v.value
}

func (v *NullableInfinibandLogicalNetwork) Set(val *InfinibandLogicalNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableInfinibandLogicalNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableInfinibandLogicalNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInfinibandLogicalNetwork(val *InfinibandLogicalNetwork) *NullableInfinibandLogicalNetwork {
	return &NullableInfinibandLogicalNetwork{value: val, isSet: true}
}

func (v NullableInfinibandLogicalNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInfinibandLogicalNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
