...
// checks if the CreateDnsZone type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateDnsZone{}

// CreateDnsZone struct for CreateDnsZone
...
type _CreateDnsZone CreateDnsZone
...
func (o CreateDnsZone) MarshalJSON() ([]byte, error) {
...
func (o CreateDnsZone) ToMap() (map[string]interface{}, error) {
...
func (o *CreateDnsZone) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateDnsZone := _CreateDnsZone{}

	err = json.Unmarshal(data, &varCreateDnsZone)

	if err != nil {
		return err
	}

	*o = CreateDnsZone(varCreateDnsZone)
...
type NullableCreateDnsZone struct {
	value *CreateDnsZone
	isSet bool
}

func (v NullableCreateDnsZone) Get() *CreateDnsZone {
	return v.value
}

func (v *NullableCreateDnsZone) Set(val *CreateDnsZone) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateDnsZone) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateDnsZone) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateDnsZone(val *CreateDnsZone) *NullableCreateDnsZone {
	return &NullableCreateDnsZone{value: val, isSet: true}
}

func (v NullableCreateDnsZone) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateDnsZone) UnmarshalJSON(src []byte) error {
	v.isSet = true
