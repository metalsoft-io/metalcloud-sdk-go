...
// checks if the BucketExtendedInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BucketExtendedInfo{}

// BucketExtendedInfo struct for BucketExtendedInfo
...
type _BucketExtendedInfo BucketExtendedInfo
...
func (o BucketExtendedInfo) MarshalJSON() ([]byte, error) {
...
func (o BucketExtendedInfo) ToMap() (map[string]interface{}, error) {
...
func (o *BucketExtendedInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varBucketExtendedInfo := _BucketExtendedInfo{}

	err = json.Unmarshal(data, &varBucketExtendedInfo)

	if err != nil {
		return err
	}

	*o = BucketExtendedInfo(varBucketExtendedInfo)
...
type NullableBucketExtendedInfo struct {
	value *BucketExtendedInfo
	isSet bool
}

func (v NullableBucketExtendedInfo) Get() *BucketExtendedInfo {
	return v.value
}

func (v *NullableBucketExtendedInfo) Set(val *BucketExtendedInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableBucketExtendedInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableBucketExtendedInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBucketExtendedInfo(val *BucketExtendedInfo) *NullableBucketExtendedInfo {
	return &NullableBucketExtendedInfo{value: val, isSet: true}
}

func (v NullableBucketExtendedInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBucketExtendedInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true
