...
// checks if the TemplateAssetCreateDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TemplateAssetCreateDto{}

// TemplateAssetCreateDto struct for TemplateAssetCreateDto
type TemplateAssetCreateDto struct {
...
type _TemplateAssetCreateDto TemplateAssetCreateDto
...
func (o TemplateAssetCreateDto) MarshalJSON() ([]byte, error) {
...
func (o TemplateAssetCreateDto) ToMap() (map[string]interface{}, error) {
...
func (o *TemplateAssetCreateDto) UnmarshalJSON(data []byte) (err error) {
	...
	varTemplateAssetCreateDto := _TemplateAssetCreateDto{}

	err = json.Unmarshal(data, &varTemplateAssetCreateDto)

	if err != nil {
		return err
	}

	*o = TemplateAssetCreateDto(varTemplateAssetCreateDto)
...
type NullableTemplateAssetCreateDto struct {
	value *TemplateAssetCreateDto
	isSet bool
}

func (v NullableTemplateAssetCreateDto) Get() *TemplateAssetCreateDto {
	return v.value
}

func (v *NullableTemplateAssetCreateDto) Set(val *TemplateAssetCreateDto) {
	v.value = val
	v.isSet = true
}

func (v NullableTemplateAssetCreateDto) IsSet() bool {
	return v.isSet
}

func (v *NullableTemplateAssetCreateDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTemplateAssetCreateDto(val *TemplateAssetCreateDto) *NullableTemplateAssetCreateDto {
	return &NullableTemplateAssetCreateDto{value: val, isSet: true}
}

func (v NullableTemplateAssetCreateDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTemplateAssetCreateDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
