...
func (r UsersAPIResendUserInvitationRequest) ResendUserInvitation(resendUserInvitation ResendUserInvitation) UsersAPIResendUserInvitationRequest {
	r.resendUserInvitation = &resendUserInvitation
	return r
}

func (r UsersAPIResendUserInvitationRequest) Execute() (*User, *http.Response, error) {
	return r.ApiService.ResendUserInvitationExecute(r)
}

/*
ResendUserInvitation Resend user invitation
...
// Execute executes the request
//  @return User
func (a *UsersAPIService) ResendUserInvitationExecute(r UsersAPIResendUserInvitationRequest) (*User, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UsersAPIService.ResendUserInvitation")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/users/{userId}/actions/resend-user-invitation"
	localVarPath = strings.Replace(localVarPath, "{"+"userId"+"}", url.PathEscape(parameterValueToString(r.userId, "userId")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.resendUserInvitation == nil {
		return localVarReturnValue, nil, reportError("resendUserInvitation is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.resendUserInvitation
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (r UsersAPISendPasswordResetByAdminRequest) PasswordResetByAdmin(passwordResetByAdmin PasswordResetByAdmin) UsersAPISendPasswordResetByAdminRequest {
	r.passwordResetByAdmin = &passwordResetByAdmin
	return r
}

func (r UsersAPISendPasswordResetByAdminRequest) Execute() (*User, *http.Response, error) {
	return r.ApiService.SendPasswordResetByAdminExecute(r)
}

/*
SendPasswordResetByAdmin Send password reset by admin
...
// Execute executes the request
//  @return User
func (a *UsersAPIService) SendPasswordResetByAdminExecute(r UsersAPISendPasswordResetByAdminRequest) (*User, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UsersAPIService.SendPasswordResetByAdmin")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/v2/users/{userId}/actions/send-password-reset"
	localVarPath = strings.Replace(localVarPath, "{"+"userId"+"}", url.PathEscape(parameterValueToString(r.userId, "userId")), -1)

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.passwordResetByAdmin == nil {
		return localVarReturnValue, nil, reportError("passwordResetByAdmin is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.passwordResetByAdmin
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
