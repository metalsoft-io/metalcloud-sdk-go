...
type UserAPIResendEmailVerificationRequest struct {
	ctx context.Context
	ApiService *UserAPIService
	resendUserVerificationEmail *ResendUserVerificationEmail
}

func (r UserAPIResendEmailVerificationRequest) ResendUserVerificationEmail(resendUserVerificationEmail ResendUserVerificationEmail) UserAPIResendEmailVerificationRequest {
	r.resendUserVerificationEmail = &resendUserVerificationEmail
	return r
}

func (r UserAPIResendEmailVerificationRequest) Execute() (*User, *http.Response, error) {
...
ResendEmailVerification Resend email verification
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return UserAPIResendEmailVerificationRequest
*/
func (a *UserAPIService) ResendEmailVerification(ctx context.Context) UserAPIResendEmailVerificationRequest {
	return UserAPIResendEmailVerificationRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return User
func (a *UserAPIService) ResendEmailVerificationExecute(r UserAPIResendEmailVerificationRequest) (*User, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localVarPath := localBasePath + "/api/v2/user/actions/resend-email-verification"
