...
/*
GetUserPermissions Get the permissions of the logged in user

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return UserAPIGetUserPermissionsRequest
*/
func (a *UserAPIService) GetUserPermissions(ctx context.Context) UserAPIGetUserPermissionsRequest {
	return UserAPIGetUserPermissionsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *UserAPIService) GetUserPermissionsExecute(r UserAPIGetUserPermissionsRequest) (*UserPermissions, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v2/user/permissions"
