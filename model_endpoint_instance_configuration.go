...
// checks if the EndpointInstanceConfiguration type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EndpointInstanceConfiguration{}
...
type _EndpointInstanceConfiguration EndpointInstanceConfiguration
...
func (o EndpointInstanceConfiguration) MarshalJSON() ([]byte, error) {
...
func (o EndpointInstanceConfiguration) ToMap() (map[string]interface{}, error) {
...
func (o *EndpointInstanceConfiguration) UnmarshalJSON(data []byte) (err error) {
	...
	varEndpointInstanceConfiguration := _EndpointInstanceConfiguration{}

	err = json.Unmarshal(data, &varEndpointInstanceConfiguration)

	if err != nil {
		return err
	}

	*o = EndpointInstanceConfiguration(varEndpointInstanceConfiguration)
...
type NullableEndpointInstanceConfiguration struct {
	value *EndpointInstanceConfiguration
	isSet bool
}

func (v NullableEndpointInstanceConfiguration) Get() *EndpointInstanceConfiguration {
	return v.value
}

func (v *NullableEndpointInstanceConfiguration) Set(val *EndpointInstanceConfiguration) {
	v.value = val
	v.isSet = true
}

func (v NullableEndpointInstanceConfiguration) IsSet() bool {
	return v.isSet
}

func (v *NullableEndpointInstanceConfiguration) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEndpointInstanceConfiguration(val *EndpointInstanceConfiguration) *NullableEndpointInstanceConfiguration {
	return &NullableEndpointInstanceConfiguration{value: val, isSet: true}
}

func (v NullableEndpointInstanceConfiguration) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEndpointInstanceConfiguration) UnmarshalJSON(src []byte) error {
	v.isSet = true
