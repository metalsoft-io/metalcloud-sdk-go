...
// checks if the OvnFabricDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OvnFabricDto{}

// OvnFabricDto struct for OvnFabricDto
type OvnFabricDto struct {
...
type _OvnFabricDto OvnFabricDto
...
func (o OvnFabricDto) MarshalJSON() ([]byte, error) {
...
func (o OvnFabricDto) ToMap() (map[string]interface{}, error) {
...
func (o *OvnFabricDto) UnmarshalJSON(data []byte) (err error) {
	...
	varOvnFabricDto := _OvnFabricDto{}

	err = json.Unmarshal(data, &varOvnFabricDto)

	if err != nil {
		return err
	}

	*o = OvnFabricDto(varOvnFabricDto)
...
type NullableOvnFabricDto struct {
	value *OvnFabricDto
	isSet bool
}

func (v NullableOvnFabricDto) Get() *OvnFabricDto {
	return v.value
}

func (v *NullableOvnFabricDto) Set(val *OvnFabricDto) {
	v.value = val
	v.isSet = true
}

func (v NullableOvnFabricDto) IsSet() bool {
	return v.isSet
}

func (v *NullableOvnFabricDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOvnFabricDto(val *OvnFabricDto) *NullableOvnFabricDto {
	return &NullableOvnFabricDto{value: val, isSet: true}
}

func (v NullableOvnFabricDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOvnFabricDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
