...
// checks if the VlanLogicalNetwork type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VlanLogicalNetwork{}

// VlanLogicalNetwork struct for VlanLogicalNetwork
type VlanLogicalNetwork struct {
	Id int32 `json:"id"`
...
type _VlanLogicalNetwork VlanLogicalNetwork
...
func (o *VlanLogicalNetwork) SetExtensionInstanceIdNil() {
...
func (o *VlanLogicalNetwork) GetConfig() VlanLogicalNetworkConfig {
	if o == nil {
		var ret VlanLogicalNetworkConfig
		return ret
	}
...
func (o *VlanLogicalNetwork) GetVlan() VlanLogicalNetworkVlanProperties {
	if o == nil {
		var ret VlanLogicalNetworkVlanProperties
		return ret
	}
...
func (o *VlanLogicalNetwork) GetIpv4() VlanLogicalNetworkIpv4Properties {
	if o == nil {
		var ret VlanLogicalNetworkIpv4Properties
		return ret
	}
...
func (o *VlanLogicalNetwork) GetIpv6() VlanLogicalNetworkIpv6Properties {
	if o == nil {
		var ret VlanLogicalNetworkIpv6Properties
		return ret
	}
...
func (o VlanLogicalNetwork) ToMap() (map[string]interface{}, error) {
...
func (o *VlanLogicalNetwork) UnmarshalJSON(data []byte) (err error) {
	...
	varVlanLogicalNetwork := _VlanLogicalNetwork{}

	err = json.Unmarshal(data, &varVlanLogicalNetwork)

	if err != nil {
		return err
	}

	*o = VlanLogicalNetwork(varVlanLogicalNetwork)
...
type NullableVlanLogicalNetwork struct {
	value *VlanLogicalNetwork
	isSet bool
}

func (v NullableVlanLogicalNetwork) Get() *VlanLogicalNetwork {
	return v.value
}

func (v *NullableVlanLogicalNetwork) Set(val *VlanLogicalNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableVlanLogicalNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableVlanLogicalNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVlanLogicalNetwork(val *VlanLogicalNetwork) *NullableVlanLogicalNetwork {
	return &NullableVlanLogicalNetwork{value: val, isSet: true}
}

func (v NullableVlanLogicalNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVlanLogicalNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
