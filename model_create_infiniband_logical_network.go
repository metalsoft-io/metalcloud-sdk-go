...
// checks if the CreateInfinibandLogicalNetwork type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateInfinibandLogicalNetwork{}

// CreateInfinibandLogicalNetwork struct for CreateInfinibandLogicalNetwork
type CreateInfinibandLogicalNetwork struct {
...
type _CreateInfinibandLogicalNetwork CreateInfinibandLogicalNetwork
...
func NewCreateInfinibandLogicalNetwork(kind LogicalNetworkKind, fabricId int32, pkey CreateInfinibandLogicalNetworkPkeyProperties, ipv4 CreateInfinibandLogicalNetworkIpv4Properties) *CreateInfinibandLogicalNetwork {
	this := CreateInfinibandLogicalNetwork{}
	this.Kind = kind
...
func (o *CreateInfinibandLogicalNetwork) SetInfrastructureIdNil() {
...
func (o *CreateInfinibandLogicalNetwork) SetRouteDomainIdNil() {
...
func (o *CreateInfinibandLogicalNetwork) SetMtuNil() {
	o.Mtu.Set(nil)
}
...
func (o CreateInfinibandLogicalNetwork) MarshalJSON() ([]byte, error) {
...
func (o CreateInfinibandLogicalNetwork) ToMap() (map[string]interface{}, error) {
...
func (o *CreateInfinibandLogicalNetwork) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateInfinibandLogicalNetwork := _CreateInfinibandLogicalNetwork{}

	err = json.Unmarshal(data, &varCreateInfinibandLogicalNetwork)

	if err != nil {
		return err
	}

	*o = CreateInfinibandLogicalNetwork(varCreateInfinibandLogicalNetwork)
...
type NullableCreateInfinibandLogicalNetwork struct {
	value *CreateInfinibandLogicalNetwork
	isSet bool
}

func (v NullableCreateInfinibandLogicalNetwork) Get() *CreateInfinibandLogicalNetwork {
	return v.value
}

func (v *NullableCreateInfinibandLogicalNetwork) Set(val *CreateInfinibandLogicalNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateInfinibandLogicalNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateInfinibandLogicalNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateInfinibandLogicalNetwork(val *CreateInfinibandLogicalNetwork) *NullableCreateInfinibandLogicalNetwork {
	return &NullableCreateInfinibandLogicalNetwork{value: val, isSet: true}
}

func (v NullableCreateInfinibandLogicalNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateInfinibandLogicalNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
