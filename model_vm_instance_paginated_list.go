...
// checks if the VMInstancePaginatedList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VMInstancePaginatedList{}

// VMInstancePaginatedList struct for VMInstancePaginatedList
type VMInstancePaginatedList struct {
...
type _VMInstancePaginatedList VMInstancePaginatedList
...
func (o VMInstancePaginatedList) MarshalJSON() ([]byte, error) {
...
func (o VMInstancePaginatedList) ToMap() (map[string]interface{}, error) {
...
func (o *VMInstancePaginatedList) UnmarshalJSON(data []byte) (err error) {
	...
	varVMInstancePaginatedList := _VMInstancePaginatedList{}

	err = json.Unmarshal(data, &varVMInstancePaginatedList)

	if err != nil {
		return err
	}

	*o = VMInstancePaginatedList(varVMInstancePaginatedList)
...
type NullableVMInstancePaginatedList struct {
	value *VMInstancePaginatedList
	isSet bool
}

func (v NullableVMInstancePaginatedList) Get() *VMInstancePaginatedList {
	return v.value
}

func (v *NullableVMInstancePaginatedList) Set(val *VMInstancePaginatedList) {
	v.value = val
	v.isSet = true
}

func (v NullableVMInstancePaginatedList) IsSet() bool {
	return v.isSet
}

func (v *NullableVMInstancePaginatedList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVMInstancePaginatedList(val *VMInstancePaginatedList) *NullableVMInstancePaginatedList {
	return &NullableVMInstancePaginatedList{value: val, isSet: true}
}

func (v NullableVMInstancePaginatedList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVMInstancePaginatedList) UnmarshalJSON(src []byte) error {
	v.isSet = true
