...
func Test_sdk_AuthenticationAPIService(t *testing.T) {
	...
	t.Run("Test AuthenticationAPIService GetPublicSignupDisabled", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.AuthenticationAPI.GetPublicSignupDisabled(context.Background()).Execute()
