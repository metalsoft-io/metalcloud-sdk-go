...
type _UpdateExtension UpdateExtension
...
func (o *UpdateExtension) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateExtension := _UpdateExtension{}

	err = json.Unmarshal(data, &varUpdateExtension)

	if err != nil {
		return err
	}

	*o = UpdateExtension(varUpdateExtension)
