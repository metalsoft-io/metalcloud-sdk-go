...
// checks if the LdapServerDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LdapServerDto{}

// LdapServerDto struct for LdapServerDto
...
type _LdapServerDto LdapServerDto
...
func (o LdapServerDto) MarshalJSON() ([]byte, error) {
...
func (o LdapServerDto) ToMap() (map[string]interface{}, error) {
...
func (o *LdapServerDto) UnmarshalJSON(data []byte) (err error) {
	varLdapServerDto := _LdapServerDto{}

	err = json.Unmarshal(data, &varLdapServerDto)

	if err != nil {
		return err
	}

	*o = LdapServerDto(varLdapServerDto)
...
type NullableLdapServerDto struct {
	value *LdapServerDto
	isSet bool
}

func (v NullableLdapServerDto) Get() *LdapServerDto {
	return v.value
}

func (v *NullableLdapServerDto) Set(val *LdapServerDto) {
	v.value = val
	v.isSet = true
}

func (v NullableLdapServerDto) IsSet() bool {
	return v.isSet
}

func (v *NullableLdapServerDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLdapServerDto(val *LdapServerDto) *NullableLdapServerDto {
	return &NullableLdapServerDto{value: val, isSet: true}
}

func (v NullableLdapServerDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLdapServerDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
