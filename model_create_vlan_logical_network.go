...
// checks if the CreateVlanLogicalNetwork type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateVlanLogicalNetwork{}

// CreateVlanLogicalNetwork struct for CreateVlanLogicalNetwork
type CreateVlanLogicalNetwork struct {
...
type _CreateVlanLogicalNetwork CreateVlanLogicalNetwork
...
func (o *CreateVlanLogicalNetwork) SetInfrastructureIdNil() {
...
func (o *CreateVlanLogicalNetwork) SetRouteDomainIdNil() {
...
func (o *CreateVlanLogicalNetwork) SetMtuNil() {
	o.Mtu.Set(nil)
}
...
func (o CreateVlanLogicalNetwork) MarshalJSON() ([]byte, error) {
...
func (o CreateVlanLogicalNetwork) ToMap() (map[string]interface{}, error) {
...
func (o *CreateVlanLogicalNetwork) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateVlanLogicalNetwork := _CreateVlanLogicalNetwork{}

	err = json.Unmarshal(data, &varCreateVlanLogicalNetwork)

	if err != nil {
		return err
	}

	*o = CreateVlanLogicalNetwork(varCreateVlanLogicalNetwork)
...
type NullableCreateVlanLogicalNetwork struct {
	value *CreateVlanLogicalNetwork
	isSet bool
}

func (v NullableCreateVlanLogicalNetwork) Get() *CreateVlanLogicalNetwork {
	return v.value
}

func (v *NullableCreateVlanLogicalNetwork) Set(val *CreateVlanLogicalNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateVlanLogicalNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateVlanLogicalNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateVlanLogicalNetwork(val *CreateVlanLogicalNetwork) *NullableCreateVlanLogicalNetwork {
	return &NullableCreateVlanLogicalNetwork{value: val, isSet: true}
}

func (v NullableCreateVlanLogicalNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateVlanLogicalNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
