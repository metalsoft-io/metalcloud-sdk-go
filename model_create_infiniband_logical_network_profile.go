...
// checks if the CreateInfinibandLogicalNetworkProfile type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateInfinibandLogicalNetworkProfile{}

// CreateInfinibandLogicalNetworkProfile struct for CreateInfinibandLogicalNetworkProfile
type CreateInfinibandLogicalNetworkProfile struct {
	Label *string `json:"label,omitempty"`
	Name *string `json:"name,omitempty"`
	Annotations *map[string]string `json:"annotations,omitempty"`
	Kind LogicalNetworkKind `json:"kind"`
	FabricId int32 `json:"fabricId"`
	Pkey CreateInfinibandLogicalNetworkPkeyProperties `json:"pkey"`
	Ipv4 CreateInfinibandLogicalNetworkIpv4Properties `json:"ipv4"`
	Ipv6 *CreateInfinibandLogicalNetworkIpv6Properties `json:"ipv6,omitempty"`
...
type _CreateInfinibandLogicalNetworkProfile CreateInfinibandLogicalNetworkProfile
...
func NewCreateInfinibandLogicalNetworkProfile(kind LogicalNetworkKind, fabricId int32, pkey CreateInfinibandLogicalNetworkPkeyProperties, ipv4 CreateInfinibandLogicalNetworkIpv4Properties) *CreateInfinibandLogicalNetworkProfile {
	this := CreateInfinibandLogicalNetworkProfile{}
	this.Kind = kind
...
func (o *CreateInfinibandLogicalNetworkProfile) GetPkey() CreateInfinibandLogicalNetworkPkeyProperties {
	if o == nil {
		var ret CreateInfinibandLogicalNetworkPkeyProperties
		return ret
	}
...
func (o *CreateInfinibandLogicalNetworkProfile) GetIpv4() CreateInfinibandLogicalNetworkIpv4Properties {
	if o == nil {
		var ret CreateInfinibandLogicalNetworkIpv4Properties
		return ret
	}
...
func (o *CreateInfinibandLogicalNetworkProfile) GetIpv6() CreateInfinibandLogicalNetworkIpv6Properties {
	if o == nil || IsNil(o.Ipv6) {
		var ret CreateInfinibandLogicalNetworkIpv6Properties
		return ret
	}
	return *o.Ipv6
}
...
// SetIpv6 gets a reference to the given CreateInfinibandLogicalNetworkIpv6Properties and assigns it to the Ipv6 field.
...
func (o *CreateInfinibandLogicalNetworkProfile) SetRouteDomainIdNil() {
...
func (o *CreateInfinibandLogicalNetworkProfile) SetMtuNil() {
	o.Mtu.Set(nil)
}
...
func (o CreateInfinibandLogicalNetworkProfile) MarshalJSON() ([]byte, error) {
...
func (o CreateInfinibandLogicalNetworkProfile) ToMap() (map[string]interface{}, error) {
...
func (o *CreateInfinibandLogicalNetworkProfile) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateInfinibandLogicalNetworkProfile := _CreateInfinibandLogicalNetworkProfile{}

	err = json.Unmarshal(data, &varCreateInfinibandLogicalNetworkProfile)

	if err != nil {
		return err
	}

	*o = CreateInfinibandLogicalNetworkProfile(varCreateInfinibandLogicalNetworkProfile)
...
type NullableCreateInfinibandLogicalNetworkProfile struct {
	value *CreateInfinibandLogicalNetworkProfile
	isSet bool
}

func (v NullableCreateInfinibandLogicalNetworkProfile) Get() *CreateInfinibandLogicalNetworkProfile {
	return v.value
}

func (v *NullableCreateInfinibandLogicalNetworkProfile) Set(val *CreateInfinibandLogicalNetworkProfile) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateInfinibandLogicalNetworkProfile) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateInfinibandLogicalNetworkProfile) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateInfinibandLogicalNetworkProfile(val *CreateInfinibandLogicalNetworkProfile) *NullableCreateInfinibandLogicalNetworkProfile {
	return &NullableCreateInfinibandLogicalNetworkProfile{value: val, isSet: true}
}

func (v NullableCreateInfinibandLogicalNetworkProfile) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateInfinibandLogicalNetworkProfile) UnmarshalJSON(src []byte) error {
	v.isSet = true
