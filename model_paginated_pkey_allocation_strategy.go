...
// checks if the PaginatedPkeyAllocationStrategy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedPkeyAllocationStrategy{}
...
type _PaginatedPkeyAllocationStrategy PaginatedPkeyAllocationStrategy
...
func (o PaginatedPkeyAllocationStrategy) MarshalJSON() ([]byte, error) {
...
func (o PaginatedPkeyAllocationStrategy) ToMap() (map[string]interface{}, error) {
...
func (o *PaginatedPkeyAllocationStrategy) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedPkeyAllocationStrategy := _PaginatedPkeyAllocationStrategy{}

	err = json.Unmarshal(data, &varPaginatedPkeyAllocationStrategy)

	if err != nil {
		return err
	}

	*o = PaginatedPkeyAllocationStrategy(varPaginatedPkeyAllocationStrategy)
...
type NullablePaginatedPkeyAllocationStrategy struct {
	value *PaginatedPkeyAllocationStrategy
	isSet bool
}

func (v NullablePaginatedPkeyAllocationStrategy) Get() *PaginatedPkeyAllocationStrategy {
	return v.value
}

func (v *NullablePaginatedPkeyAllocationStrategy) Set(val *PaginatedPkeyAllocationStrategy) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedPkeyAllocationStrategy) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedPkeyAllocationStrategy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedPkeyAllocationStrategy(val *PaginatedPkeyAllocationStrategy) *NullablePaginatedPkeyAllocationStrategy {
	return &NullablePaginatedPkeyAllocationStrategy{value: val, isSet: true}
}

func (v NullablePaginatedPkeyAllocationStrategy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedPkeyAllocationStrategy) UnmarshalJSON(src []byte) error {
	v.isSet = true
