...
// checks if the EthernetEvpnVxlanL3FabricDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EthernetEvpnVxlanL3FabricDto{}

// EthernetEvpnVxlanL3FabricDto struct for EthernetEvpnVxlanL3FabricDto
type EthernetEvpnVxlanL3FabricDto struct {
...
type _EthernetEvpnVxlanL3FabricDto EthernetEvpnVxlanL3FabricDto
...
func NewEthernetEvpnVxlanL3FabricDto(defaultNetworkProfileId float32, numberOfSpinesNextToLeafSwitches float32) *EthernetEvpnVxlanL3FabricDto {
	this := EthernetEvpnVxlanL3FabricDto{}
...
func (o EthernetEvpnVxlanL3FabricDto) MarshalJSON() ([]byte, error) {
...
func (o EthernetEvpnVxlanL3FabricDto) ToMap() (map[string]interface{}, error) {
...
func (o *EthernetEvpnVxlanL3FabricDto) UnmarshalJSON(data []byte) (err error) {
	...
	varEthernetEvpnVxlanL3FabricDto := _EthernetEvpnVxlanL3FabricDto{}

	err = json.Unmarshal(data, &varEthernetEvpnVxlanL3FabricDto)

	if err != nil {
		return err
	}

	*o = EthernetEvpnVxlanL3FabricDto(varEthernetEvpnVxlanL3FabricDto)
...
type NullableEthernetEvpnVxlanL3FabricDto struct {
	value *EthernetEvpnVxlanL3FabricDto
	isSet bool
}

func (v NullableEthernetEvpnVxlanL3FabricDto) Get() *EthernetEvpnVxlanL3FabricDto {
	return v.value
}

func (v *NullableEthernetEvpnVxlanL3FabricDto) Set(val *EthernetEvpnVxlanL3FabricDto) {
	v.value = val
	v.isSet = true
}

func (v NullableEthernetEvpnVxlanL3FabricDto) IsSet() bool {
	return v.isSet
}

func (v *NullableEthernetEvpnVxlanL3FabricDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEthernetEvpnVxlanL3FabricDto(val *EthernetEvpnVxlanL3FabricDto) *NullableEthernetEvpnVxlanL3FabricDto {
	return &NullableEthernetEvpnVxlanL3FabricDto{value: val, isSet: true}
}

func (v NullableEthernetEvpnVxlanL3FabricDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEthernetEvpnVxlanL3FabricDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
