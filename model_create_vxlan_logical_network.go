...
// checks if the CreateVxlanLogicalNetwork type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateVxlanLogicalNetwork{}

// CreateVxlanLogicalNetwork struct for CreateVxlanLogicalNetwork
type CreateVxlanLogicalNetwork struct {
...
type _CreateVxlanLogicalNetwork CreateVxlanLogicalNetwork
...
func NewCreateVxlanLogicalNetwork(kind LogicalNetworkKind, fabricId int32, vlan CreateVxlanLogicalNetworkVlanProperties, vxlan CreateVxlanLogicalNetworkVxlanProperties, ipv4 CreateVxlanLogicalNetworkIpv4Properties) *CreateVxlanLogicalNetwork {
	this := CreateVxlanLogicalNetwork{}
	this.Kind = kind
...
func (o *CreateVxlanLogicalNetwork) SetInfrastructureIdNil() {
...
func (o *CreateVxlanLogicalNetwork) SetRouteDomainIdNil() {
...
func (o *CreateVxlanLogicalNetwork) SetMtuNil() {
	o.Mtu.Set(nil)
}
...
func (o CreateVxlanLogicalNetwork) MarshalJSON() ([]byte, error) {
...
func (o CreateVxlanLogicalNetwork) ToMap() (map[string]interface{}, error) {
...
func (o *CreateVxlanLogicalNetwork) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateVxlanLogicalNetwork := _CreateVxlanLogicalNetwork{}

	err = json.Unmarshal(data, &varCreateVxlanLogicalNetwork)

	if err != nil {
		return err
	}

	*o = CreateVxlanLogicalNetwork(varCreateVxlanLogicalNetwork)
...
type NullableCreateVxlanLogicalNetwork struct {
	value *CreateVxlanLogicalNetwork
	isSet bool
}

func (v NullableCreateVxlanLogicalNetwork) Get() *CreateVxlanLogicalNetwork {
	return v.value
}

func (v *NullableCreateVxlanLogicalNetwork) Set(val *CreateVxlanLogicalNetwork) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateVxlanLogicalNetwork) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateVxlanLogicalNetwork) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateVxlanLogicalNetwork(val *CreateVxlanLogicalNetwork) *NullableCreateVxlanLogicalNetwork {
	return &NullableCreateVxlanLogicalNetwork{value: val, isSet: true}
}

func (v NullableCreateVxlanLogicalNetwork) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateVxlanLogicalNetwork) UnmarshalJSON(src []byte) error {
	v.isSet = true
