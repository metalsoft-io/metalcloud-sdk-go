...
// checks if the FileShareHostType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileShareHostType{}

// FileShareHostType struct for FileShareHostType
type FileShareHostType struct {
	// File Share Host Ids that will be connected.
	WillBeConnected []string `json:"willBeConnected"`
	// File Share Host Ids that are connected.
	Connected []string `json:"connected"`
	// File Share Host Ids that will be disconnected.
	WillBeDisconnected []string `json:"willBeDisconnected"`
	// File Share Host Ids that are disconnected.
	Disconnected []string `json:"disconnected"`
	AdditionalProperties map[string]interface{}
}

type _FileShareHostType FileShareHostType
...
func (o FileShareHostType) MarshalJSON() ([]byte, error) {
...
func (o FileShareHostType) ToMap() (map[string]interface{}, error) {
...
func (o *FileShareHostType) UnmarshalJSON(data []byte) (err error) {
	...
	varFileShareHostType := _FileShareHostType{}

	err = json.Unmarshal(data, &varFileShareHostType)

	if err != nil {
		return err
	}

	*o = FileShareHostType(varFileShareHostType)
...
type NullableFileShareHostType struct {
	value *FileShareHostType
	isSet bool
}

func (v NullableFileShareHostType) Get() *FileShareHostType {
	return v.value
}

func (v *NullableFileShareHostType) Set(val *FileShareHostType) {
	v.value = val
	v.isSet = true
}

func (v NullableFileShareHostType) IsSet() bool {
	return v.isSet
}

func (v *NullableFileShareHostType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileShareHostType(val *FileShareHostType) *NullableFileShareHostType {
	return &NullableFileShareHostType{value: val, isSet: true}
}

func (v NullableFileShareHostType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileShareHostType) UnmarshalJSON(src []byte) error {
	v.isSet = true
