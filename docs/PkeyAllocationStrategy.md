...
`func NewPkeyAllocationStrategy(id int64, createdAt time.Time, updatedAt time.Time, kind AllocationStrategyKind, scope ResourceScope, pkey int32, ) *PkeyAllocationStrategy`
...
`func (o *PkeyAllocationStrategy) GetId() int64`

GetId returns the Id field if non-nil, zero value otherwise.

### GetIdOk

`func (o *PkeyAllocationStrategy) GetIdOk() (*int64, bool)`
...
`func (o *PkeyAllocationStrategy) SetId(v int64)`
