...
`func (o *CreateNetworkEndpointGroupLogicalNetwork) GetInterfaceCount() int32`

GetInterfaceCount returns the InterfaceCount field if non-nil, zero value otherwise.

### GetInterfaceCountOk

`func (o *CreateNetworkEndpointGroupLogicalNetwork) GetInterfaceCountOk() (*int32, bool)`
...
`func (o *CreateNetworkEndpointGroupLogicalNetwork) SetInterfaceCount(v int32)`

SetInterfaceCount sets InterfaceCount field to given value.

### HasInterfaceCount

`func (o *CreateNetworkEndpointGroupLogicalNetwork) HasInterfaceCount() bool`

HasInterfaceCount returns a boolean if a field has been set.

### SetInterfaceCountNil

`func (o *CreateNetworkEndpointGroupLogicalNetwork) SetInterfaceCountNil(b bool)`

 SetInterfaceCountNil sets the value for InterfaceCount to be an explicit nil

### UnsetInterfaceCount
`func (o *CreateNetworkEndpointGroupLogicalNetwork) UnsetInterfaceCount()`
...
`func (o *CreateNetworkEndpointGroupLogicalNetwork) GetDisableAutoIpAllocationOk() (*bool, bool)`
