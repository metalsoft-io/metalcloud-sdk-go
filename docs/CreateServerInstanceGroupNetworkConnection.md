...
`func (o *CreateServerInstanceGroupNetworkConnection) GetInterfaceCount() int32`

GetInterfaceCount returns the InterfaceCount field if non-nil, zero value otherwise.

### GetInterfaceCountOk

`func (o *CreateServerInstanceGroupNetworkConnection) GetInterfaceCountOk() (*int32, bool)`
...
`func (o *CreateServerInstanceGroupNetworkConnection) SetInterfaceCount(v int32)`

SetInterfaceCount sets InterfaceCount field to given value.

### HasInterfaceCount

`func (o *CreateServerInstanceGroupNetworkConnection) HasInterfaceCount() bool`

HasInterfaceCount returns a boolean if a field has been set.

### SetInterfaceCountNil

`func (o *CreateServerInstanceGroupNetworkConnection) SetInterfaceCountNil(b bool)`

 SetInterfaceCountNil sets the value for InterfaceCount to be an explicit nil

### UnsetInterfaceCount
`func (o *CreateServerInstanceGroupNetworkConnection) UnsetInterfaceCount()`
...
`func (o *CreateServerInstanceGroupNetworkConnection) GetDisableAutoIpAllocation() bool`
...
`func (o *CreateServerInstanceGroupNetworkConnection) GetDisableAutoIpAllocationOk() (*bool, bool)`
...
`func (o *CreateServerInstanceGroupNetworkConnection) SetDisableAutoIpAllocation(v bool)`

SetDisableAutoIpAllocation sets DisableAutoIpAllocation field to given value.

### HasDisableAutoIpAllocation

`func (o *CreateServerInstanceGroupNetworkConnection) HasDisableAutoIpAllocation() bool`
...
`func (o *CreateServerInstanceGroupNetworkConnection) GetDns() DnsRecordsEndpointGroupLogicalNetwork`

GetDns returns the Dns field if non-nil, zero value otherwise.

### GetDnsOk

`func (o *CreateServerInstanceGroupNetworkConnection) GetDnsOk() (*DnsRecordsEndpointGroupLogicalNetwork, bool)`
...
`func (o *CreateServerInstanceGroupNetworkConnection) SetDns(v DnsRecordsEndpointGroupLogicalNetwork)`

SetDns sets Dns field to given value.

### HasDns

`func (o *CreateServerInstanceGroupNetworkConnection) HasDns() bool`

HasDns returns a boolean if a field has been set.

### SetDnsNil

`func (o *CreateServerInstanceGroupNetworkConnection) SetDnsNil(b bool)`

 SetDnsNil sets the value for Dns to be an explicit nil

### UnsetDns
`func (o *CreateServerInstanceGroupNetworkConnection) UnsetDns()`
