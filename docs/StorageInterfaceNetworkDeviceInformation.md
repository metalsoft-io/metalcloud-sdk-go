# StorageInterfaceNetworkDeviceInformation
...
### NewStorageInterfaceNetworkDeviceInformationWithDefaults
...
GetNetworkDeviceName returns the NetworkDeviceName field if non-nil, zero value otherwise.

### GetNetworkDeviceNameOk

`func (o *StorageInterfaceNetworkDeviceInformation) GetNetworkDeviceNameOk() (*string, bool)`

GetNetworkDeviceNameOk returns a tuple with the NetworkDeviceName field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetNetworkDeviceName sets NetworkDeviceName field to given value.
