...
`func (o *CreateNetworkEndpointGroup) GetSiteId() int64`

GetSiteId returns the SiteId field if non-nil, zero value otherwise.

### GetSiteIdOk

`func (o *CreateNetworkEndpointGroup) GetSiteIdOk() (*int64, bool)`
...
`func (o *CreateNetworkEndpointGroup) SetSiteId(v int64)`
