...
------------ | ------------- | ------------- | -------------
**Data** | [**[]Ipv6SubnetAllocationStrategy2DataItem**](Ipv6SubnetAllocationStrategy2DataItem.md) |  | 
...
`func NewPaginatedIpv6SubnetAllocationStrategy(data []Ipv6SubnetAllocationStrategy2DataItem, meta PaginatedResponseMeta, links PaginatedResponseLinks, ) *PaginatedIpv6SubnetAllocationStrategy`
...
`func (o *PaginatedIpv6SubnetAllocationStrategy) GetData() []Ipv6SubnetAllocationStrategy2DataItem`

GetData returns the Data field if non-nil, zero value otherwise.

### GetDataOk

`func (o *PaginatedIpv6SubnetAllocationStrategy) GetDataOk() (*[]Ipv6SubnetAllocationStrategy2DataItem, bool)`
...
`func (o *PaginatedIpv6SubnetAllocationStrategy) SetData(v []Ipv6SubnetAllocationStrategy2DataItem)`
