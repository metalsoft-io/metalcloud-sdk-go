...
`func NewCreateExternalConnection(label string, name string, fabricId int64, ) *CreateExternalConnection`
...
`func (o *CreateExternalConnection) GetFabricId() int64`

GetFabricId returns the FabricId field if non-nil, zero value otherwise.

### GetFabricIdOk

`func (o *CreateExternalConnection) GetFabricIdOk() (*int64, bool)`
...
`func (o *CreateExternalConnection) SetFabricId(v int64)`
