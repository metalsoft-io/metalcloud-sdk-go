...
------------ | ------------- | ------------- | -------------
**ContainerArrayContainersMaxCount** | Pointer to **float32** |  | [optional] 
**ContainerArrayContainersMinCount** | Pointer to **float32** |  | [optional] 
**ContainerArrayDriveArraysMaxCount** | Pointer to **float32** |  | [optional] 
**ContainerArrayDriveArraysMinCount** | Pointer to **float32** |  | [optional] 
**ContainerArraySecretsMaxCount** | Pointer to **float32** |  | [optional] 
**ContainerPlatformContainerArrayMaxCount** | Pointer to **float32** |  | [optional] 
**DriveArrayDrivesMaxCount** | Pointer to **float32** |  | [optional] 
**DriveArrayDrivesMinCount** | Pointer to **float32** |  | [optional] 
**DriveMaxSizeMbytes** | Pointer to **float32** |  | [optional] 
**DriveMinSizeMbytes** | Pointer to **float32** |  | [optional] 
**InfrastructureActiveMaxCount** | Pointer to **float32** |  | [optional] 
**InfrastructureClusterMaxCount** | Pointer to **float32** |  | [optional] 
**InfrastructureClusterMysqlAllowed** | Pointer to **bool** |  | [optional] 
**InfrastructureContainerClusterKafkaAllowed** | Pointer to **bool** |  | [optional] 
**InfrastructureContainerClusterMaxCount** | Pointer to **float32** |  | [optional] 
**InfrastructureContainerClusterPostgresqlAllowed** | Pointer to **bool** |  | [optional] 
**InfrastructureContainerClusterSparkArrayAllowed** | Pointer to **bool** |  | [optional] 
**InfrastructureContainerClusterSparksqlAllowed** | Pointer to **bool** |  | [optional] 
**InfrastructureContainerClusterStreamsetsAllowed** | Pointer to **bool** |  | [optional] 
**InfrastructureContainerClusterZookeeperAllowed** | Pointer to **bool** |  | [optional] 
**InfrastructureContainerClusterZoomdataAllowed** | Pointer to **bool** |  | [optional] 
**InfrastructureContainerPlatformMaxCount** | Pointer to **float32** |  | [optional] 
**InfrastructureDataLakeEnabled** | Pointer to **bool** |  | [optional] 
**InfrastructureDataLakeMaxCount** | Pointer to **float32** |  | [optional] 
**InfrastructureDeletedMaxCount** | Pointer to **float32** |  | [optional] 
**InfrastructureDriveArrayMaxCount** | Pointer to **float32** |  | [optional] 
**InfrastructureInactiveMaxCount** | Pointer to **float32** |  | [optional] 
**InfrastructureInstanceArrayMaxCount** | Pointer to **float32** |  | [optional] 
...
**InstanceArrayInstancesMinCount** | Pointer to **float32** |  | [optional] 
**InfrastructureVmInstanceGroupMaxCount** | Pointer to **float32** |  | [optional] 
**VmInstanceGroupVmInstancesMaxCount** | Pointer to **float32** |  | [optional] 
**VmInstanceMaxDiskSizeMbytes** | Pointer to **float32** |  | [optional] 
**OwnerIsBillable** | Pointer to **bool** |  | [optional] 
**ServerTypeReservationMaxCount** | Pointer to **float32** |  | [optional] 
...
**ShowTemplateAssetsView** | Pointer to **bool** |  | [optional] 
**StorageTypes** | Pointer to **[]string** |  | [optional] 
**ThresholdMaxCount** | Pointer to **float32** |  | [optional] 
**UserResourceIscsiStorageSpaceMaxGbytes** | Pointer to **float32** |  | [optional] 
**UserResourceServersMaxCount** | Pointer to **float32** |  | [optional] 
...
### GetContainerArrayDriveArraysMaxCountOk
...
GetDriveArrayDrivesMaxCountOk returns a tuple with the DriveArrayDrivesMaxCount field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetInfrastructureActiveMaxCount sets InfrastructureActiveMaxCount field to given value.
...
### GetInfrastructureInstanceArrayMaxCountOk
...
SetInstanceArrayInstancesMaxCount sets InstanceArrayInstancesMaxCount field to given value.
...
### GetServerTypeReservationMaxQuantity
...
### GetUserResourceIscsiStorageSpaceMaxGbytes
...
### HasShowDiagramAppClusterTypeCloudera
...
### GetShowDiagramAppClusterTypeKubernetes
...
GetShowDiagramAppClusterTypeSplunk returns the ShowDiagramAppClusterTypeSplunk field if non-nil, zero value otherwise.
...
### GetShowDiagramAppClusterTypeVmwareVcfOk
...
SetShowStackTrace sets ShowStackTrace field to given value.
