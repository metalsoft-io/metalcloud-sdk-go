...
`func (o *UpdateNetworkEndpointGroupLogicalNetwork) GetInterfaceCount() int32`

GetInterfaceCount returns the InterfaceCount field if non-nil, zero value otherwise.

### GetInterfaceCountOk

`func (o *UpdateNetworkEndpointGroupLogicalNetwork) GetInterfaceCountOk() (*int32, bool)`
...
`func (o *UpdateNetworkEndpointGroupLogicalNetwork) SetInterfaceCount(v int32)`

SetInterfaceCount sets InterfaceCount field to given value.

### HasInterfaceCount

`func (o *UpdateNetworkEndpointGroupLogicalNetwork) HasInterfaceCount() bool`

HasInterfaceCount returns a boolean if a field has been set.

### SetInterfaceCountNil

`func (o *UpdateNetworkEndpointGroupLogicalNetwork) SetInterfaceCountNil(b bool)`

 SetInterfaceCountNil sets the value for InterfaceCount to be an explicit nil

### UnsetInterfaceCount
`func (o *UpdateNetworkEndpointGroupLogicalNetwork) UnsetInterfaceCount()`
