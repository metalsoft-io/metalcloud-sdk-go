...
`func (o *UpdateNetworkEndpointGroup) GetSiteId() int64`

GetSiteId returns the SiteId field if non-nil, zero value otherwise.

### GetSiteIdOk

`func (o *UpdateNetworkEndpointGroup) GetSiteIdOk() (*int64, bool)`
...
`func (o *UpdateNetworkEndpointGroup) SetSiteId(v int64)`
