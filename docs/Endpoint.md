...
**SiteId** | **int64** | The ID of the site where the entity is located. | 
...
`func NewEndpoint(id string, revision string, siteId int64, name string, label string, createdTimestamp time.Time, updatedTimestamp time.Time, ) *Endpoint`
...
`func (o *Endpoint) GetSiteId() int64`

GetSiteId returns the SiteId field if non-nil, zero value otherwise.

### GetSiteIdOk

`func (o *Endpoint) GetSiteIdOk() (*int64, bool)`
...
`func (o *Endpoint) SetSiteId(v int64)`
