...
------------ | ------------- | ------------- | -------------
**Id** | **int64** | The ID of the server default credentials | 
...
`func (o *ServerDefaultCredentials) HasServerSerialNumber() bool`
...
`func (o *ServerDefaultCredentials) HasServerMacAddress() bool`
