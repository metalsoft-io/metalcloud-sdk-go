...
`func NewFirmwareBaselinePaginatedList(data []FirmwareBaseline, meta PaginatedResponseMeta, ) *FirmwareBaselinePaginatedList`
...
`func (o *FirmwareBaselinePaginatedList) HasLinks() bool`
