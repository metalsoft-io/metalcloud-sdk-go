...
`func NewVlanAllocationStrategy(id int64, createdAt time.Time, updatedAt time.Time, kind AllocationStrategyKind, scope ResourceScope, granularityLevel NullableVlanAllocationGranularityLevel, vlanId int32, ) *VlanAllocationStrategy`
...
`func (o *VlanAllocationStrategy) GetId() int64`

GetId returns the Id field if non-nil, zero value otherwise.

### GetIdOk

`func (o *VlanAllocationStrategy) GetIdOk() (*int64, bool)`
...
`func (o *VlanAllocationStrategy) SetId(v int64)`
