...
------------ | ------------- | ------------- | -------------
**Revision** | **float32** | Revision of the Shared Drive Configuration | 
...
**DnsSubdomainChangeId** | Pointer to **float32** | Id of the DNS subdomain for the Shared Drive. | [optional] 
**DeployType** | **string** | Deploy type of the Shared Drive | [default to "create"]
**DeployStatus** | **string** | Deploy status of the Shared Drive | [default to "not_started"]
**InfrastructureDeployId** | Pointer to **float32** | Id of the deployment for the Shared Drive. | [optional] 
