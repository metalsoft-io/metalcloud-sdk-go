...
type ServerInstanceCredentials struct {
	...
	// The initial SSH keys.
	InitialSshKeys []SSHKey `json:"initialSshKeys,omitempty"`
...
// GetInitialSshKeys returns the InitialSshKeys field value if set, zero value otherwise.
func (o *ServerInstanceCredentials) GetInitialSshKeys() []SSHKey {
	if o == nil || IsNil(o.InitialSshKeys) {
		var ret []SSHKey
		return ret
	}
	return o.InitialSshKeys
}

// GetInitialSshKeysOk returns a tuple with the InitialSshKeys field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ServerInstanceCredentials) GetInitialSshKeysOk() ([]SSHKey, bool) {
	if o == nil || IsNil(o.InitialSshKeys) {
		return nil, false
	}
	return o.InitialSshKeys, true
}
...
// SetInitialSshKeys gets a reference to the given []SSHKey and assigns it to the InitialSshKeys field.
...
func (o ServerInstanceCredentials) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.InitialSshKeys) {
		toSerialize["initialSshKeys"] = o.InitialSshKeys
	}
...
func (o *ServerInstanceCredentials) UnmarshalJSON(data []byte) (err error) {
	...
	*o = ServerInstanceCredentials(varServerInstanceCredentials)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "initialSshKeys")
