...
// checks if the EthernetFlatL2Fabric type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EthernetFlatL2Fabric{}

// EthernetFlatL2Fabric struct for EthernetFlatL2Fabric
type EthernetFlatL2Fabric struct {
...
type _EthernetFlatL2Fabric EthernetFlatL2Fabric
...
func (o EthernetFlatL2Fabric) MarshalJSON() ([]byte, error) {
...
func (o EthernetFlatL2Fabric) ToMap() (map[string]interface{}, error) {
...
func (o *EthernetFlatL2Fabric) UnmarshalJSON(data []byte) (err error) {
	...
	varEthernetFlatL2Fabric := _EthernetFlatL2Fabric{}

	err = json.Unmarshal(data, &varEthernetFlatL2Fabric)

	if err != nil {
		return err
	}

	*o = EthernetFlatL2Fabric(varEthernetFlatL2Fabric)
...
type NullableEthernetFlatL2Fabric struct {
	value *EthernetFlatL2Fabric
	isSet bool
}

func (v NullableEthernetFlatL2Fabric) Get() *EthernetFlatL2Fabric {
	return v.value
}

func (v *NullableEthernetFlatL2Fabric) Set(val *EthernetFlatL2Fabric) {
	v.value = val
	v.isSet = true
}

func (v NullableEthernetFlatL2Fabric) IsSet() bool {
	return v.isSet
}

func (v *NullableEthernetFlatL2Fabric) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEthernetFlatL2Fabric(val *EthernetFlatL2Fabric) *NullableEthernetFlatL2Fabric {
	return &NullableEthernetFlatL2Fabric{value: val, isSet: true}
}

func (v NullableEthernetFlatL2Fabric) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEthernetFlatL2Fabric) UnmarshalJSON(src []byte) error {
	v.isSet = true
