...
// checks if the EthernetHybridL2L3FabricDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EthernetHybridL2L3FabricDto{}

// EthernetHybridL2L3FabricDto struct for EthernetHybridL2L3FabricDto
type EthernetHybridL2L3FabricDto struct {
...
type _EthernetHybridL2L3FabricDto EthernetHybridL2L3FabricDto
...
func NewEthernetHybridL2L3FabricDto(defaultNetworkProfileId float32, numberOfSpinesNextToLeafSwitches float32) *EthernetHybridL2L3FabricDto {
	this := EthernetHybridL2L3FabricDto{}
...
func (o EthernetHybridL2L3FabricDto) MarshalJSON() ([]byte, error) {
...
func (o EthernetHybridL2L3FabricDto) ToMap() (map[string]interface{}, error) {
...
func (o *EthernetHybridL2L3FabricDto) UnmarshalJSON(data []byte) (err error) {
	...
	varEthernetHybridL2L3FabricDto := _EthernetHybridL2L3FabricDto{}

	err = json.Unmarshal(data, &varEthernetHybridL2L3FabricDto)

	if err != nil {
		return err
	}

	*o = EthernetHybridL2L3FabricDto(varEthernetHybridL2L3FabricDto)
...
type NullableEthernetHybridL2L3FabricDto struct {
	value *EthernetHybridL2L3FabricDto
	isSet bool
}

func (v NullableEthernetHybridL2L3FabricDto) Get() *EthernetHybridL2L3FabricDto {
	return v.value
}

func (v *NullableEthernetHybridL2L3FabricDto) Set(val *EthernetHybridL2L3FabricDto) {
	v.value = val
	v.isSet = true
}

func (v NullableEthernetHybridL2L3FabricDto) IsSet() bool {
	return v.isSet
}

func (v *NullableEthernetHybridL2L3FabricDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEthernetHybridL2L3FabricDto(val *EthernetHybridL2L3FabricDto) *NullableEthernetHybridL2L3FabricDto {
	return &NullableEthernetHybridL2L3FabricDto{value: val, isSet: true}
}

func (v NullableEthernetHybridL2L3FabricDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEthernetHybridL2L3FabricDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
