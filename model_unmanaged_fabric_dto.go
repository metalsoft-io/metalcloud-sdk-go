...
// checks if the UnmanagedFabricDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UnmanagedFabricDto{}

// UnmanagedFabricDto struct for UnmanagedFabricDto
type UnmanagedFabricDto struct {
...
type _UnmanagedFabricDto UnmanagedFabricDto
...
func (o UnmanagedFabricDto) MarshalJSON() ([]byte, error) {
...
func (o UnmanagedFabricDto) ToMap() (map[string]interface{}, error) {
...
func (o *UnmanagedFabricDto) UnmarshalJSON(data []byte) (err error) {
	...
	varUnmanagedFabricDto := _UnmanagedFabricDto{}

	err = json.Unmarshal(data, &varUnmanagedFabricDto)

	if err != nil {
		return err
	}

	*o = UnmanagedFabricDto(varUnmanagedFabricDto)
...
type NullableUnmanagedFabricDto struct {
	value *UnmanagedFabricDto
	isSet bool
}

func (v NullableUnmanagedFabricDto) Get() *UnmanagedFabricDto {
	return v.value
}

func (v *NullableUnmanagedFabricDto) Set(val *UnmanagedFabricDto) {
	v.value = val
	v.isSet = true
}

func (v NullableUnmanagedFabricDto) IsSet() bool {
	return v.isSet
}

func (v *NullableUnmanagedFabricDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUnmanagedFabricDto(val *UnmanagedFabricDto) *NullableUnmanagedFabricDto {
	return &NullableUnmanagedFabricDto{value: val, isSet: true}
}

func (v NullableUnmanagedFabricDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUnmanagedFabricDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
