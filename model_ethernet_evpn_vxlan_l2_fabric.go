...
// checks if the EthernetEvpnVxlanL2Fabric type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EthernetEvpnVxlanL2Fabric{}
...
type _EthernetEvpnVxlanL2Fabric EthernetEvpnVxlanL2Fabric
...
func (o EthernetEvpnVxlanL2Fabric) MarshalJSON() ([]byte, error) {
...
func (o EthernetEvpnVxlanL2Fabric) ToMap() (map[string]interface{}, error) {
...
func (o *EthernetEvpnVxlanL2Fabric) UnmarshalJSON(data []byte) (err error) {
	...
	varEthernetEvpnVxlanL2Fabric := _EthernetEvpnVxlanL2Fabric{}

	err = json.Unmarshal(data, &varEthernetEvpnVxlanL2Fabric)

	if err != nil {
		return err
	}

	*o = EthernetEvpnVxlanL2Fabric(varEthernetEvpnVxlanL2Fabric)
...
type NullableEthernetEvpnVxlanL2Fabric struct {
	value *EthernetEvpnVxlanL2Fabric
	isSet bool
}

func (v NullableEthernetEvpnVxlanL2Fabric) Get() *EthernetEvpnVxlanL2Fabric {
	return v.value
}

func (v *NullableEthernetEvpnVxlanL2Fabric) Set(val *EthernetEvpnVxlanL2Fabric) {
	v.value = val
	v.isSet = true
}

func (v NullableEthernetEvpnVxlanL2Fabric) IsSet() bool {
	return v.isSet
}

func (v *NullableEthernetEvpnVxlanL2Fabric) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEthernetEvpnVxlanL2Fabric(val *EthernetEvpnVxlanL2Fabric) *NullableEthernetEvpnVxlanL2Fabric {
	return &NullableEthernetEvpnVxlanL2Fabric{value: val, isSet: true}
}

func (v NullableEthernetEvpnVxlanL2Fabric) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEthernetEvpnVxlanL2Fabric) UnmarshalJSON(src []byte) error {
	v.isSet = true
