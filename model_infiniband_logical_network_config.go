...
// checks if the InfinibandLogicalNetworkConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InfinibandLogicalNetworkConfig{}

// InfinibandLogicalNetworkConfig struct for InfinibandLogicalNetworkConfig
type InfinibandLogicalNetworkConfig struct {
	Id int32 `json:"id"`
	...
	Pkey InfinibandLogicalNetworkConfigPkeyProperties `json:"pkey"`
	Ipv4 InfinibandLogicalNetworkConfigIpv4Properties `json:"ipv4"`
	Ipv6 InfinibandLogicalNetworkConfigIpv6Properties `json:"ipv6"`
	AdditionalProperties map[string]interface{}
}

type _InfinibandLogicalNetworkConfig InfinibandLogicalNetworkConfig
...
func NewInfinibandLogicalNetworkConfig(id int32, deployType string, deployStatus string, createdAt time.Time, updatedAt time.Time, revision int32, kind LogicalNetworkKind, pkey InfinibandLogicalNetworkConfigPkeyProperties, ipv4 InfinibandLogicalNetworkConfigIpv4Properties, ipv6 InfinibandLogicalNetworkConfigIpv6Properties) *InfinibandLogicalNetworkConfig {
	this := InfinibandLogicalNetworkConfig{}
	this.Id = id
...
func (o *InfinibandLogicalNetworkConfig) SetMtuNil() {
	o.Mtu.Set(nil)
}
...
func (o *InfinibandLogicalNetworkConfig) GetPkey() InfinibandLogicalNetworkConfigPkeyProperties {
	if o == nil {
		var ret InfinibandLogicalNetworkConfigPkeyProperties
		return ret
	}
...
func (o *InfinibandLogicalNetworkConfig) GetIpv4() InfinibandLogicalNetworkConfigIpv4Properties {
	if o == nil {
		var ret InfinibandLogicalNetworkConfigIpv4Properties
		return ret
	}
...
func (o *InfinibandLogicalNetworkConfig) GetIpv6() InfinibandLogicalNetworkConfigIpv6Properties {
	if o == nil {
		var ret InfinibandLogicalNetworkConfigIpv6Properties
		return ret
	}
...
func (o InfinibandLogicalNetworkConfig) MarshalJSON() ([]byte, error) {
...
func (o InfinibandLogicalNetworkConfig) ToMap() (map[string]interface{}, error) {
...
func (o *InfinibandLogicalNetworkConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varInfinibandLogicalNetworkConfig := _InfinibandLogicalNetworkConfig{}

	err = json.Unmarshal(data, &varInfinibandLogicalNetworkConfig)

	if err != nil {
		return err
	}

	*o = InfinibandLogicalNetworkConfig(varInfinibandLogicalNetworkConfig)
...
type NullableInfinibandLogicalNetworkConfig struct {
	value *InfinibandLogicalNetworkConfig
	isSet bool
}

func (v NullableInfinibandLogicalNetworkConfig) Get() *InfinibandLogicalNetworkConfig {
	return v.value
}

func (v *NullableInfinibandLogicalNetworkConfig) Set(val *InfinibandLogicalNetworkConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableInfinibandLogicalNetworkConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableInfinibandLogicalNetworkConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInfinibandLogicalNetworkConfig(val *InfinibandLogicalNetworkConfig) *NullableInfinibandLogicalNetworkConfig {
	return &NullableInfinibandLogicalNetworkConfig{value: val, isSet: true}
}

func (v NullableInfinibandLogicalNetworkConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInfinibandLogicalNetworkConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
